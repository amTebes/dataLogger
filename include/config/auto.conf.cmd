...
ifneq "$(KERNELVERSION)" "5.9.14"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/ctw00838/ISEP/ARCOM/buildroot-rpi/output/host/usr/bin/arm-linux-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/ctw00838/ISEP/ARCOM/buildroot-rpi/output/host/usr/bin/arm-linux-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
...
ifneq "$(CC_VERSION_TEXT)" "arm-linux-gcc.br_real (Buildroot 2020.11) 9.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/ctw00838/ISEP/ARCOM/buildroot-rpi/output/host/usr/bin/arm-linux-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/ctw00838/ISEP/ARCOM/buildroot-rpi/output/host/usr/bin/arm-linux-objcopy"
include/config/auto.conf: FORCE
endif
